...
>
    ...
    >
        ...
        <input
            ...
            x-model="query"
            x-ref="search"
            class="relative block h-10 w-full lg:w-1/2 lg:focus:w-3/4 bg-transparent border border-gray-500 focus:border-blue-400 outline-none cursor-pointer text-gray-700 px-4 pb-0 pt-px transition-all duration-200 ease-out bg-no-repeat bg-[0.8rem] indent-[1.2em]"
        ...
        >
            <div class="flex flex-col border border-b-0 border-t-0 border-[var(--link)] rounded-b-lg shadow-search mx-4 md:mx-0">
                <template x-for="(result, index) in results">
                    <a
                        class="bg-[var(--bg)] border-b border-blue-400 text-xl cursor-pointer p-4"
                    ...
                    >
                        ...
                        <span class="block font-normal text-[var(--bg)] hover:text-[var(--link)] text-sm my-1" x-html="result.item.snippet"></span>
                    </a>
                </template>
                <div
                    x-show="! results.length"
                    class="bg-[var(--bg)] w-full hover:bg-[var(--link)] border-b border-blue-400 rounded-b-lg shadow cursor-pointer p-4"
                >
